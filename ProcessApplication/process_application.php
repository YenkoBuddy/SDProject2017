...
if($stmt1->execute()){
	$sql2 ="INSERT INTO driver(FirstName, LastName, IDNo, ContactNumber, EmailAddress, Address1, SuburbID, ProofOfResidence, DriversLicence, LicenceExpiryDate, PrDP, PrDPExpiryDate, Photo)
	VALUES (:firstName, :lastName, :IDNo, :contactNumber, :email, :address1, :suburbID, :proofOfResidence, :driversLicence, :licenceExpiryDate, :prdp, :prdpExpiryDate, :photo)";
