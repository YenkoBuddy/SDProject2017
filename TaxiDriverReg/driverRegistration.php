<?php
     ...
     if(isset($_POST['btnFinish']))
    {
        ...
        $sql = "INSERT INTO application(FirstName, lastName, IDNo, ContactNumber, EmailAddress, Address1, SuburbID, ProofOfResidence, DriversLicence,PrDP, Photo) 
...
<h1><b>Driver Details</b></h1>
<label>The taxi registered for this driver is: <?php echo $_SESSION['RegNo']; ?> <?php echo $_SESSION['Type']; ?>     
                </label>
