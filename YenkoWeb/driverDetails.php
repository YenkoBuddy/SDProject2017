...
<table>
	...
	<tr>
		<td colspan="3"> <input type="text" name="streetAddress" placeholder="Street Address" style="text-align: center"> * </td>
	</tr>
	<tr>
	...
	<tr>
		<td> PrDP </td>
		<td> <input type="button" name="btnChoose2" value="Choose File"> *</td>
	</tr>
	<tr>
		<td><input type="button" name="btnFinish" value="Finish"></td>
	</tr>
</table>
